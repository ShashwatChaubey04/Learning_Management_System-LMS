    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative item-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className="pt-4 md:text-base text-sm" dangerouslySetInnerHTML={{__html: courseData.courseDescription.length > 400 ? courseData.courseDescription.slice(0, 300) + "....." : courseData.courseDescription}}></p>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>OOPs With Code</span></p>
                ...
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={() => toggleSection(index)}>
                    <div className='flex items-center gap-2'>
                      <img className={`transform transition-transform ${openSections[index] ? 'rotate-180' : 'rotate-0'}`} src={assets.down_arrow_icon} alt="down_arrow_icon" />
        ...
        <div className='max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] h-fit'>
          {
            playerData ?
            <YouTube videoId={playerData.videoId} opts={{playerVars: {}}}  iframeClassName='w-full aspect-video'/>
            :
          ...
          <div className='p-5'>
            ...
            <div className='flex gap-3 items-center pt-2'>
              <p className='text-gray-800 md:text-2xl text-1xl font-semibold'>{currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice /100).toFixed(2)}</p>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>Steps-by-step, hands-on project guidance.</li>
