...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 px-4 md:px-0 md:my-16 my-10 gap-8 mt-14 mx-auto max-w-2xl lg:max-w-6xl'>
                ...
                <div className='flex gap-0.5'>
                  {[...Array(5)].map((_, i) => (
                    <img 
                      key={i}
                      className='h-5' 
                      src={i<Math.floor(testimonials.rating) ? assets.star : assets.star_blank} alt='' />
                  ))}
                </div>
